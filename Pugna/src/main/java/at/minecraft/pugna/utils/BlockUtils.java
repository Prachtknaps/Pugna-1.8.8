...
public final class BlockUtils {
    ...
    private static void loadProtectedAreasIntoSets()
    {
        ...
        List<Location> protectedLocations = GameConfig.getProtectedAreas();
        for (Location protectedLocation : protectedLocations) {
            ...
            if (worldName.equals(GameConfig.getPugnaWorldName())) {
                PROTECTED_KEYS_OVERWORLD.add(key);
            } else if (worldName.equals(GameConfig.getPugnaNetherWorldName())) {
