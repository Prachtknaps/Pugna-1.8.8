...
public class EnemyRevealEvent extends GameEvent {
    private final int countdownStartSeconds;
    private final int eventSeconds;
    private boolean triggered;

    public EnemyRevealEvent(int countdownStartSeconds, int eventSeconds) {
        ...
        if (seconds >= countdownStartSeconds && seconds < eventSeconds) {
            ...
            for (Player player : Bukkit.getOnlinePlayers()) {
                ...
                if (closestEnemy != null) {
                    ...
                    String message = MessageConfig.getChatMessage(Message.ENEMY_REVEAL_SUCCESS)
