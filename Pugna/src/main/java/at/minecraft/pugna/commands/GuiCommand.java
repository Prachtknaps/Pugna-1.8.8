...
public class GuiCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] arguments) {
        ...
        if (arguments.length != 1) {
            ...
            String usageMessage = ChatConfig.getMessage(Message.GUI_USAGE);
        ...
        switch (subCommand) {
            case "enable":
                if (gameTimer != null) {
                    ...
                    String message = ChatConfig.getMessage(Message.GUI_ENABLED);
            ...
            case "disable":
                if (gameTimer != null) {
                    ...
                    String message = ChatConfig.getMessage(Message.GUI_DISABLED);
                    player.sendMessage(message);
                }
                return true;
            default:
