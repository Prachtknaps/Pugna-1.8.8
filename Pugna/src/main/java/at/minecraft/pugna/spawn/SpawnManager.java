package at.minecraft.pugna.spawn;
...
public class SpawnManager {
    ...
    public static void buildSpawnHoles(World world, int maxTeamsCount, int maxTeamCapacity, int radius) {
        if (world == null) {
            return;
        }
    ...
    public static void buildDevSpawnHoles(World world, int spawnCount) {
        if (world == null) {
            return;
        }
        ...
        for (int spawnIndex = 0; spawnIndex < spawnCount; spawnIndex++) {
            ...
            PlayerSpawn spawn = new PlayerSpawn(world, blockX, blockZ);
            spawn.build();
        }
    }
    ...
    public static void buildNetherPortal(World world) {
        ...
        NetherPortal portal = new NetherPortal(world, centerX, centerZ);
        portal.build();
    }
